...
def smacof(dissimilarities, metric=True, n_components=2, init=None, n_init=8,
           ...
           return_n_iter=False, history=None):
    ...
    if n_jobs == 1:
        for it in range(n_init):
            pos, stress, n_iter_ = _smacof_single(
                ...
                eps=eps, random_state=random_state, history=history)
        ...
        results = Parallel(n_jobs=n_jobs, verbose=max(verbose - 1, 0))(
            delayed(_smacof_single)(
                ...
                random_state=seed, history=history)
            for seed in seeds)
...
class MDS(BaseEstimator):
    ...
    def __init__(self, n_components=2, metric=True, n_init=4,
                 ...
                 random_state=None, dissimilarity="euclidean", history_path=None):
    ...
    def fit_transform(self, X, y=None, init=None):
        ...
        self.embedding_, self.stress_, self.n_iter_ = smacof(
            ...
            return_n_iter=True, history=self.history_observer)
